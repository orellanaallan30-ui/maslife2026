              ...
              <div className="bg-white rounded-3xl lg:rounded-[2.5rem] p-4 lg:p-8 shadow-2xl border border-slate-200 animate-in slide-in-from-right-8 duration-300">
                ...
                {doctor.paymentEnabled ? (
                  <div className="space-y-3 w-full">
                    ...
                    {/* Respaldo: si el formulario en-página no cargó, ofrecer
                        Checkout Pro (página segura de MP, sin app ni cuenta). */}
                    {brickStatus === 'error' && (
                      <div className="space-y-2">
                        <p className="text-[11px] text-slate-500 text-center font-bold">
                          Paga de forma segura en MercadoPago (no necesitas la app ni una cuenta):
                        </p>
                        <button
